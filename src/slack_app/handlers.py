        ...
        try:
            ...
            for channel in channels:
                ...
                while True:
                    ...
                    for msg in messages:
                        all_messages.append(format_message(msg, channel_id, channel_name))
            ...
            respond(f"Extracted {len(all_messages)} messages from {len(channels)} channels and saved to `{output_path}`.")
